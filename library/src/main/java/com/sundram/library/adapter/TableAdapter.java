package com.sundram.library.adapter;
...
public interface TableAdapter {
     ...
     * @param column the column. If the column is <code>-1</code> it is the
     *            header.
     ...
     * @param row the row. If the row is <code>-1</code> it is the header.
